...
import reducer, {
  ...
  reset,
  updateEntity,
} from './booking-outbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGOUTBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKINGOUTBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKINGOUTBOXEVENT actions', async () => {
      const arg = { id: 24297 };
    ...
    it('dispatches UPDATE_BOOKINGOUTBOXEVENT actions', async () => {
      const arg = { id: 24297 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGOUTBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKINGOUTBOXEVENT actions', async () => {
      const arg = 42666;
