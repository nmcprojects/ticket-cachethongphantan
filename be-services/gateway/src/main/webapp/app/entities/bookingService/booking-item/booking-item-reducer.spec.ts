...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKINGITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKINGITEM actions', async () => {
      const arg = { id: 28054 };
    ...
    it('dispatches UPDATE_BOOKINGITEM actions', async () => {
      const arg = { id: 28054 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKINGITEM actions', async () => {
      const arg = 42666;
