...
import reducer, {
  ...
  reset,
  updateEntity,
} from './booking-status-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGSTATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKINGSTATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKINGSTATUSHISTORY actions', async () => {
      const arg = { id: 9022 };
    ...
    it('dispatches UPDATE_BOOKINGSTATUSHISTORY actions', async () => {
      const arg = { id: 9022 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGSTATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKINGSTATUSHISTORY actions', async () => {
      const arg = 42666;
