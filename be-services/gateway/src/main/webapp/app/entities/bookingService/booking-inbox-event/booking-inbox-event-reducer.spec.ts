...
import reducer, {
  ...
  reset,
  updateEntity,
} from './booking-inbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGINBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOKINGINBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOKINGINBOXEVENT actions', async () => {
      const arg = { id: 22640 };
    ...
    it('dispatches UPDATE_BOOKINGINBOXEVENT actions', async () => {
      const arg = { id: 22640 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGINBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOKINGINBOXEVENT actions', async () => {
      const arg = 42666;
