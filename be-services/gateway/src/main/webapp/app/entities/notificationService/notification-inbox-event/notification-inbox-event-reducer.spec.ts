...
import reducer, {
  ...
  reset,
  updateEntity,
} from './notification-inbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONINBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTIFICATIONINBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTIFICATIONINBOXEVENT actions', async () => {
      const arg = { id: 1109 };
    ...
    it('dispatches UPDATE_NOTIFICATIONINBOXEVENT actions', async () => {
      const arg = { id: 1109 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONINBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTIFICATIONINBOXEVENT actions', async () => {
      const arg = 42666;
