...
import reducer, {
  ...
  reset,
  updateEntity,
} from './email-notification.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILNOTIFICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMAILNOTIFICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMAILNOTIFICATION actions', async () => {
      const arg = { id: 11231 };
    ...
    it('dispatches UPDATE_EMAILNOTIFICATION actions', async () => {
      const arg = { id: 11231 };
    ...
    it('dispatches PARTIAL_UPDATE_EMAILNOTIFICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMAILNOTIFICATION actions', async () => {
      const arg = 42666;
