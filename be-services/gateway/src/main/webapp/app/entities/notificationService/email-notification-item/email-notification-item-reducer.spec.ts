...
import reducer, {
  ...
  reset,
  updateEntity,
} from './email-notification-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILNOTIFICATIONITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMAILNOTIFICATIONITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMAILNOTIFICATIONITEM actions', async () => {
      const arg = { id: 30181 };
    ...
    it('dispatches UPDATE_EMAILNOTIFICATIONITEM actions', async () => {
      const arg = { id: 30181 };
    ...
    it('dispatches PARTIAL_UPDATE_EMAILNOTIFICATIONITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMAILNOTIFICATIONITEM actions', async () => {
      const arg = 42666;
