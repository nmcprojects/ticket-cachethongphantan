...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKINLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKINLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKINLOG actions', async () => {
      const arg = { id: 4432 };
    ...
    it('dispatches UPDATE_CHECKINLOG actions', async () => {
      const arg = { id: 4432 };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKINLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHECKINLOG actions', async () => {
      const arg = 42666;
