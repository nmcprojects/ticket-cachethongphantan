...
import reducer, {
  ...
  reset,
  updateEntity,
} from './ticket-outbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETOUTBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETOUTBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETOUTBOXEVENT actions', async () => {
      const arg = { id: 12329 };
    ...
    it('dispatches UPDATE_TICKETOUTBOXEVENT actions', async () => {
      const arg = { id: 12329 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETOUTBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETOUTBOXEVENT actions', async () => {
      const arg = 42666;
