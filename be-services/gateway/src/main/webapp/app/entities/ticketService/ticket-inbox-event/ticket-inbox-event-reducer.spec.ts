...
import reducer, {
  ...
  reset,
  updateEntity,
} from './ticket-inbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETINBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETINBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETINBOXEVENT actions', async () => {
      const arg = { id: 3780 };
    ...
    it('dispatches UPDATE_TICKETINBOXEVENT actions', async () => {
      const arg = { id: 3780 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETINBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETINBOXEVENT actions', async () => {
      const arg = 42666;
