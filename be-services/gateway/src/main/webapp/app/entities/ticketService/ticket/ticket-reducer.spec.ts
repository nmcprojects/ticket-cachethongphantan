...
import { ITicket, defaultValue } from 'app/shared/model/ticketService/ticket.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './ticket.reducer';
