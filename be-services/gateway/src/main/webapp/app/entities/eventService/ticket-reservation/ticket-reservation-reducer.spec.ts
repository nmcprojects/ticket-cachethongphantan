...
import reducer, {
  ...
  reset,
  updateEntity,
} from './ticket-reservation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETRESERVATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETRESERVATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETRESERVATION actions', async () => {
      const arg = { id: 2523 };
    ...
    it('dispatches UPDATE_TICKETRESERVATION actions', async () => {
      const arg = { id: 2523 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETRESERVATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETRESERVATION actions', async () => {
      const arg = 42666;
