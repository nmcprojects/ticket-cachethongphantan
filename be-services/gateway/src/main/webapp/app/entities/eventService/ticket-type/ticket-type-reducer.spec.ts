...
import { ITicketType, defaultValue } from 'app/shared/model/eventService/ticket-type.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETTYPE actions', async () => {
      const arg = { id: 26385 };
    ...
    it('dispatches UPDATE_TICKETTYPE actions', async () => {
      const arg = { id: 26385 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETTYPE actions', async () => {
      const arg = 42666;
