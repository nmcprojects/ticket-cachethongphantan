...
import reducer, {
  ...
  reset,
  updateEntity,
} from './organizer-profile.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZERPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZERPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZERPROFILE actions', async () => {
      const arg = { id: 20521 };
    ...
    it('dispatches UPDATE_ORGANIZERPROFILE actions', async () => {
      const arg = { id: 20521 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZERPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZERPROFILE actions', async () => {
      const arg = 42666;
