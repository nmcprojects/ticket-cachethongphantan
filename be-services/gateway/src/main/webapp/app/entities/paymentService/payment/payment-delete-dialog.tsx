...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.paymentServicePayment.delete.question">
        <Translate contentKey="gatewayApp.paymentServicePayment.delete.question" interpolate={{ id: paymentEntity.id }}>
