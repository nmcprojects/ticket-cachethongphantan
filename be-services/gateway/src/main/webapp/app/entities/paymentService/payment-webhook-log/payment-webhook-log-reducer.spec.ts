...
import reducer, {
  ...
  reset,
  updateEntity,
} from './payment-webhook-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTWEBHOOKLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTWEBHOOKLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTWEBHOOKLOG actions', async () => {
      const arg = { id: 19022 };
    ...
    it('dispatches UPDATE_PAYMENTWEBHOOKLOG actions', async () => {
      const arg = { id: 19022 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTWEBHOOKLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTWEBHOOKLOG actions', async () => {
      const arg = 42666;
