...
import reducer, {
  ...
  reset,
  updateEntity,
} from './payment-outbox-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTOUTBOXEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTOUTBOXEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTOUTBOXEVENT actions', async () => {
      const arg = { id: 4746 };
    ...
    it('dispatches UPDATE_PAYMENTOUTBOXEVENT actions', async () => {
      const arg = { id: 4746 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTOUTBOXEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTOUTBOXEVENT actions', async () => {
      const arg = 42666;
