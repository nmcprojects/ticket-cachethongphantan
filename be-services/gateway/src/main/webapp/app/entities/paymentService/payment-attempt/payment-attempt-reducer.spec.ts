...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTATTEMPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTATTEMPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTATTEMPT actions', async () => {
      const arg = { id: 5673 };
    ...
    it('dispatches UPDATE_PAYMENTATTEMPT actions', async () => {
      const arg = { id: 5673 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTATTEMPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTATTEMPT actions', async () => {
      const arg = 42666;
