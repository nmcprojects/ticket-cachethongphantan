...
import com.ticketbooking.payment.service.PaymentWebhookLogService;
...
/**
 * REST controller for managing {@link com.ticketbooking.payment.domain.PaymentWebhookLog}.
 */
@RestController
...
public class PaymentWebhookLogResource {
     ...
     */
    @GetMapping("")
    public List<PaymentWebhookLogDTO> getAllPaymentWebhookLogs() {
        LOG.debug("REST request to get all PaymentWebhookLogs");
        return paymentWebhookLogService.findAll();
    }
